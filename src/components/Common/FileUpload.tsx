...
type FileMimeTypes = 'image/png' | 'image/jpeg' | 'application/pdf' | 'application/vnd.openxmlformats-officedocument.spreadsheetml.sheet';
...
const FileUpload: React.FC<Props> = ({
  id,
  label,
  acceptMimeTypes = ['image/png', 'image/jpeg', 'application/vnd.openxmlformats-officedocument.spreadsheetml.sheet'],
  setImage,
  ...
  useEffect(() => {
    ...
    } else if( imageUrl && imageUrl.includes('base64')){
      setUpload(true);
      setImagePreview({
        name:'user_image',
        url: imageUrl,
    ...
    >
      {!isUploaded ? (
        <>
          ...
          >
            <img src={acceptMimeTypes[0] === 'application/vnd.openxmlformats-officedocument.spreadsheetml.sheet' ? xlsxPreview : FileDefault} className="mx-auto " alt="" />
        ...
        <>
          ...
          >
            <div className="flex justify-center items-center space-x-6">
              <img
                src={imageMeta.type === 'application/pdf' ? PDFPreview : imageMeta.type === 'application/vnd.openxmlformats-officedocument.spreadsheetml.sheet' ? xlsxPreview : imageMeta.url}
                alt=""
