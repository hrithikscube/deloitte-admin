...
const ResetButton = ({ onClick }: any) => {
    return (
        <div onClick={onClick} className='border p-[6px] rounded-lg border-black'>
...
const Logs = ({ visitor_id }: any) => {
    ...
    const getVisitorLogs = () => {
        ...
        axiosInstance.get(`/admin/visitors/logs/${visitor_id}?page=${currentPage}&start_date=&end_date=`)
            .then((response) => {
        ...
        <div className='w-full rounded flex flex-col gap-6'>
            <div className='default_container bg-white '>
                ...
                <div className='overflow-x-auto'>
                    <div className='mb-5 flex flex-row justify-between items-center lg:w-full w-[1140px] overflow-x-auto'>
                        {/* filter params */}
